...
class TodoItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todo_item" do
    assert_difference('TodoItem.count') do
      post todo_items_url, params: { todo_item: { description: @todo_item.description, due_date: @todo_item.due_date, task_title: @todo_item.task_title } }
    end
  ...
  test "should update todo_item" do
    patch todo_item_url(@todo_item), params: { todo_item: { description: @todo_item.description, due_date: @todo_item.due_date, task_title: @todo_item.task_title } }
